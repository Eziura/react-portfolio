...
export default class BlogForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            content: "",
            featured_image: "",
            apiUrl: "https://eziura.devcamp.space/portfolio/portfolio_blogs",
            apiAction: "post"
        };
    ...
    componentDidMount() {
        if (this.props.editMode) {
            this.setState({
                ...
                apiUrl: `https://eziura.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
                apiAction: "patch"
            });
        }
    }
    ...
    componentConfig() {
        return {
            //Show the file tags but strictly allow just these
